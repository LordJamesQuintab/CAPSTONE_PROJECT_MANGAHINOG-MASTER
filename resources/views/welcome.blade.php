...
<x-navbar>
    ...
    <main class="text-center py-20 px-6 bg-white dark:bg-gray-800 font-sans">
        ...
        @auth
        <a href="/login"
            class="bg-green-800 text-white py-2 px-6 rounded-md inline-flex items-center justify-center space-x-2 shadow hover:bg-gray-900 transition duration-300 ease-in-out">
    ...
    <section class="flex flex-col items-center justify-center pt-8 px-36 min-h-screen w-full bg-white dark:bg-gray-800">
        @if (count($threads) == 0)
            <p class="text-gray-600 dark:text-gray-300">No Available Thread</p>
        @endif
